...
/*
  Attempts to turn language codes into flag emojis.
  Will need some cleaning up......
*/
export default function getFlag(language) {
  return;


  if(!language) return;
  const pair = flags.find(f => {
    return f[1].findIndex(lang => {
      return lang.startsWith(language)
    }) >= 0
  })
  return pair && flag(pair[0])
}
...
const flags = [
  ...
  ['PF', ['fr-PF', 'ty']],
  ['PG', ['en-PG', 'ho', 'meu', 'tpi']],
  ['PH', ['tl', 'en-PH', 'fil', 'ceb', 'tgl', 'ilo', 'hil', 'war', 'pam', 'bik', 'bcl', 'pag', 'mrw', 'tsg', 'mdh', 'cbk', 'krj', 'sgd', 'msb', 'akl', 'ibg', 'yka', 'mta', 'abx']],
  ...
  ['RO', ['ro', 'hu', 'rom']],
  ['RS', ['sr', 'hu', 'bs', 'rom']],
  ['RU', ['ru', 'tt', 'xal', 'cau', 'ady', 'kv', 'ce', 'tyv', 'cv', 'udm', 'tut', 'mns', 'bua', 'myv', 'mdf', 'chm', 'ba', 'inh', 'tut', 'kbd', 'krc', 'av', 'sah', 'nog']],
