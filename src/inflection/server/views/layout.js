...
exports.default = ({ title, string, results, id, embed, did_you_mean_in_footer /* For when one main variant is shown */, }) => `
<!DOCTYPE html>
<html>
...
${id
    ? `<a href="https://bin.arnastofnun.is/beyging/${id}" target="_blank"><b>View this word on BÍN</b></a>`
    : ""}
