...
exports.FindIrregularities = void 0;
...
function FindIrregularities() {
    ...
    if (word.isAny("indeclinable", "article", "pronoun", "personal pronoun", "reflexive pronoun", "preposition", "infinitive particle", "interjection", "adverb"))
        return;
    ...
    if ((0, patterns_1.isHighlyIrregular)(word)) {
        wordIsIrregular = true;
        wordIsHighlyIrregular = true;
    }
    word.rows.forEach((row) => {
        const form = row.inflectional_form;
        const form_without_ending = (0, patterns_1.removeInflectionalPattern)(form, new word_1.default([row], word));
        const consonants_in_stem = (0, vowels_1.removeVowellikeClusters)(stem);
        const consonants_in_form_without_ending = (0, vowels_1.removeVowellikeClusters)(form_without_ending);
        let output = form;
        let hasAnElision;
        /*
         * Test umlaut
        ...
        if (!form.startsWith(stem)) {
            let letters = (0, vowels_1.splitOnVowels)(form);
            const vowels_in_stem = (0, vowels_1.getVowelClusters)(stem) || [];
            const vowels_in_form_without_ending = (0, vowels_1.getVowelClusters)(form_without_ending) || [];
...
exports.FindIrregularities = FindIrregularities;
// /*
//
