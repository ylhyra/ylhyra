...
exports.isHighlyIrregular = exports.removeInflectionalPattern = void 0;
...
const removeInflectionalPattern = (input, word) => {
    ...
    if (word.isAny("adjective", "past participle") /*|| word.is('with definite article')*/) {
        ...
        const sibling_classification = (0, lodash_1.without)(word.getFirstClassification(), ...classification_1.types["cases"]);
        const siblings = word
            .getOriginal()
            .get(...sibling_classification)
            .get(1);
        const word_case_index = classification_1.types["cases"].indexOf(word.getType("case"));
        let ending = "";
        ...
        if (word.is(1)) {
            const result = possible_endings_for_gender.find((pattern) => {
                return pattern.every((ending, index) => {
                    const case_ = classification_1.types["cases"][index];
...
exports.removeInflectionalPattern = removeInflectionalPattern;
/*
...
exports.isHighlyIrregular = isHighlyIrregular;
