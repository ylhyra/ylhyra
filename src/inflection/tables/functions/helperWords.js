...
exports.getHelperWordsAfter = exports.getHelperWordsBefore = void 0;
...
function getHelperWordsBefore() {
    ...
    if (this.is("noun") ||
        ...
        text = (0, link_1.default)("helper words for declension", text);
    }
...
exports.getHelperWordsBefore = getHelperWordsBefore;
/**
 * After
 * @module Word
...
function getHelperWordsAfter() {
    ...
    if (this.is("noun", "with definite article")) {
        ...
        text = (0, link_1.default)("helper words for the article", text);
    }
...
exports.getHelperWordsAfter = getHelperWordsAfter;
