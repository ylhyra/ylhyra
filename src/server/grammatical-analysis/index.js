...
const CreateIDs_1 = require("documents/parse/Tokenize/IDs/CreateIDs");
const icelandic_1 = __importDefault(require("server/grammatical-analysis/icelandic"));
...
*/
exports.default = (tokenized) => {
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        let input_sentences = [];
        let output_sentences = {};
        tokenized.forEach((paragraph) => {
            paragraph.sentences.forEach((sentence) => {
                if (CreateIDs_1.wordRegex.test(sentence.text)) {
        ...
        yield input_sentences.forEachAsync(({ id, text }) => __awaiter(void 0, void 0, void 0, function* () {
            yield new Promise((resolve2) => {
                (0, icelandic_1.default)(text, (output) => {
    ...
    Object.keys(sentences).forEach((sentence_id) => {
        ...
        */
        ...
        a_text_array.forEach((a_word, a_index) => {
            ...
            else if (w_text_array[w_index] &&
                a_word.startsWith(w_text_array[w_index])) {
                let temp_word = "";
                let temp_output_ids = [];
                while (temp_word !== a_word &&
                    w_index <= w_text_array.length &&
                    w_index <= tokenization.length) {
                    temp_word += w_text_array[w_index];
                    if (!tokenization[w_index])
