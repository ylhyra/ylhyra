/*
  Input:  ISO 639-3 (three letter)
  Output: ISO 639-1 (two letter)
*/
export const get_ISO_639_1 = (ISO_639_3) => {
  const language = data.find((l) => l[1] === ISO_639_3);
  if (language) {
    return language[2];
  }
  return false;
...
export const getLanguage = (ISO_639_3) => {
  const language = data.find((l) => l[1] === ISO_639_3);
  if (language) {
    return language[0];
  }
...
/*
  Derived from the work of [Titus Wormer](https://github.com/wooorm/iso-639-3).

  [Language name, ISO 639-3, ISO 639-1]
*/
const data = [
  ["Ghotuo", "aaa"],
  ["Alumu-Tesu", "aab"],
