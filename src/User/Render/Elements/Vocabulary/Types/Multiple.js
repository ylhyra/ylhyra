...
import Answers from 'User/Render/Elements/Vocabulary/elements/Answers'
import Emoji from 'User/Render/Elements/Vocabulary/elements/emoji'
import Table from 'User/Render/Elements/Vocabulary/elements/table'
import clean from 'User/Render/Elements/Vocabulary/functions/clean'
import Prompt from 'User/Render/Elements/Vocabulary/Prompt'
    ...
    return (
      <div>
        ...
        <Answers answer={answer} card={card} id={this.props.id} submitAnswer={this.props.submitAnswer}>
          {card.options && card.options.filter(Boolean).map(({icelandic, english}, index) => (
            <div key={index}>
              {card.to === 'is' && (
                <div>
