...
/**
 * Input is any unformatted string such as the
 * raw Icelandic side or English side.
 ...
 * - Kemur{{ðu}}
 *
 * The words "ætlarðu" and "ertu" are automatically given these curly
 * braces, as they are so common ({@see automaticThuForCommonWords}).
 *
...
export function automaticThuForCommonWords(input: string) {
  return input
