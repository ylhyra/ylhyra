 ...
 * with the associated translation data stored as a data value in inline span tags ({@see DocumentationRegardingInlineDataInHtml})
 *
 *
 * Here, we receive an HTML document with the associated translation data
 */
