...
import { breadcrumbs } from "ylhyra/content/documents/compile/templates/breadcrumbs";
import { parseVocabularyList } from "ylhyra/content/documents/compile/vocabulary";
