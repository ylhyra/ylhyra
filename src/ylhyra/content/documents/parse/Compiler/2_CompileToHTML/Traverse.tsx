...
import Sentence from "ylhyra/content/documents/parse/Compiler/2_CompileToHTML/Sentence";
import Word from "ylhyra/content/documents/parse/Compiler/2_CompileToHTML/Word";
