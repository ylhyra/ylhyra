 ...
 */
import { supportsTouch } from "src/modules/isBrowser";
import React from "react";
import { connect, ConnectedProps } from "react-redux";
import store, { RootState } from "src/ylhyra/app/app/store";
import {
  TextEventListenersOff,
  textEventListenersOn,
} from "src/ylhyra/content/frontend/read/touch";
import {
  close,
  prevWord,
  reset,
  start,
  startStop,
} from "src/ylhyra/content/frontend/render/elements.NOT_USED/Speed_reading.NOT_USED/actions/actions";
import {
  checkKey,
  mouseListener,
} from "src/ylhyra/content/frontend/render/elements.NOT_USED/Speed_reading.NOT_USED/actions/eventListeners";
import { load } from "src/ylhyra/content/frontend/render/elements.NOT_USED/Speed_reading.NOT_USED/actions/load";
