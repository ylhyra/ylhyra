...
} from "ylhyra/content/documents/read/touch";
import {
  close,
  prevWord,
  reset,
  start,
  startStop,
} from "ylhyra/content/documents/render/elements/Speed_reading.NOT_USED/actions/actions";
import {
  checkKey,
  mouseListener,
} from "ylhyra/content/documents/render/elements/Speed_reading.NOT_USED/actions/eventListeners";
import { load } from "ylhyra/content/documents/render/elements/Speed_reading.NOT_USED/actions/load";
