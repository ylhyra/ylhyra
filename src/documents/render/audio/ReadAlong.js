...
exports.ReadAlongMessage = exports.ReadAlongSingleSentence = exports.reset = exports.ReadAlongSetup = exports.clear = exports.ReadAlong = void 0;
const store_1 = __importDefault(require("app/app/store"));
const ScrollIntoView_1 = __importDefault(require("documents/render/audio/Scroll/ScrollIntoView"));
...
exports.clear = clear;
const ReadAlongSetup = (data) => {
    if (!data || !data.long_audio) {
        return (0, exports.clear)();
    }
...
exports.ReadAlongSetup = ReadAlongSetup;
/*
...
const Show = (index, time, auto = true) => {
    ...
    (0, ScrollIntoView_1.default)(current.elements.filter((i) => previous.elements.indexOf(i) === -1));
    (0, helpers_1.addClass)(current.elements.filter((i) => previous.elements.indexOf(i) === -1), "audioPlaying");
    (0, helpers_1.removeClass)(previous.elements.filter((i) => current.elements.indexOf(i) === -1), "audioPlaying");
...
const reset = () => {
    (0, helpers_1.removeClass)(previous.elements);
    previous = { elements: [] };
};
exports.reset = reset;
/*
...
exports.ReadAlongSingleSentence = ReadAlongSingleSentence;
/*
  TEMPORARY SOLUTION
...
exports.ReadAlongMessage = ReadAlongMessage;
