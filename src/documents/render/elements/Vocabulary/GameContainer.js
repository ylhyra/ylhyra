...
import { ParseHTMLtoArray } from "documents/render/elements/parse";
import Vocabulary from "documents/render/elements/Vocabulary";
import Progress from "documents/render/elements/Vocabulary/Progress";
      ...
      <div>
        {cards[currentIndex] ? (
          <Vocabulary
            ...
            continueGameContainer={this.continueGameContainer}
          />
        ) : (
        ...
        <div>
          <a className="button" onClick={this.previous}>
            Previous
          </a>
