...
import { getTextFromReactElement as getText} from 'User/Render/Elements/parse'
...
export const EqualOrSimilar = (correctAnswer, userAnswer) => {
  ...
  */
  ...
  /*
    ...
    PASSA SIG! ÞEGAR MAÐUR ER SVO AÐ SKRIFA SETNIGNAR SEM BYRJA Í ALVÖRU Á "ÞÚ" ÞÁ VIRKAR ÞETTA EKKI
  */
