...
function FindAGoodPositionForTooltip({ relative, tooltip, sentence, }) {
    if (!tooltip)
        return {
            top: undefined,
            left: undefined,
    ...
    const ofan = {
        ...
        left: Math.min(window.innerWidth - tooltip.width, Math.max(window.pageXOffset, sentence.left +
            sentence.width / 2 -
            tooltip.width / 2 -
            relative.left +
            addition)),
...
exports.default = FindAGoodPositionForTooltip;
